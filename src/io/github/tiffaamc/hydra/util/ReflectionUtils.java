package io.github.tiffaamc.hydra.util;
 ...
 * <ul>
 * <li>Don'c1 claim this class as your own
 * <li>Don'c1 remove this disclaimer
 * </ul>
 * <p>
...
public final class ReflectionUtils
{
     ...
     *         types of the constructor (this should not occur since it searches for a constructor
     ...
     *         circumstances
     * @throws IllegalArgumentException If the types of the arguments do not match the parameter
     *         types of the method (this should not occur since it searches for a method with the
     ...
     * @return The value of field of the target object
     * @throws IllegalArgumentException If the target object does not feature the desired field
     *         (should not occur since it searches for a field with the given name in the class of
     *         the object)
     * @throws IllegalAccessException If the desired field cannot be accessed
    ...
    public enum PackageType
    {
        MINECRAFT_SERVER("net.minecraft.server." + getServerVersion()), CRAFTBUKKIT(
                "org.bukkit.craftbukkit." + getServerVersion()), CRAFTBUKKIT_BLOCK(CRAFTBUKKIT,
                        "block"), CRAFTBUKKIT_CHUNKIO(CRAFTBUKKIT, "chunkio"), CRAFTBUKKIT_COMMAND(
                                CRAFTBUKKIT, "command"), CRAFTBUKKIT_CONVERSATIONS(CRAFTBUKKIT,
    ...
    public enum DataType
    {
        BYTE(byte.class, Byte.class), SHORT(short.class, Short.class), INTEGER(int.class,
                Integer.class), LONG(long.class, Long.class), CHARACTER(char.class,
                        Character.class), FLOAT(float.class, Float.class), DOUBLE(double.class,
